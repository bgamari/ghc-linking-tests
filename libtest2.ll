...
; This is an alias to @internal which can be called from
; outside of this object but only through the PLT
@internal_ext = alias external i32 () * @internal

; This function calls @internal directly
...
; This function calls @internal through the PLT
define i32 @external2() nounwind uwtable {
  %1 = call i32 @internal_ext()
  %2 = add nsw i32 5, %1
  ret i32 %2
}
